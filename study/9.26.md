...
파일제출할 때 asp를 지우고x64 지우기 vcx프로젝트, sln파일만 있으면 된다 
...
CsliderDlg::CsliderDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SLIDER_DIALOG, pParent)
{
...
void CsliderDlg::OnPaint()
{
	...
	CClientDC dc(this);
		dc.Ellipse(m_Pnt.x- m_Pos, m_Pnt.y - m_Pos, m_Pnt.x + m_Pos, m_Pnt.y + m_Pos);
}
...
void CsliderDlg::OnLButtonDown(UINT nFlags, CPoint point)
{
